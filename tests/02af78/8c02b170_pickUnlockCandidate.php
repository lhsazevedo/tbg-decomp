...
/*
 * _pickUnlockCandidate_8c02b170(void): filters the candidate table indices
 * in var_8c228520 (built by scanUnlockCandidates_8c02b03c) down to the ones
 * whose segmentId_0x02 matches var_currentSegment_8c228708 and whose
 * conditions_0x08 var_8c1ba2b4-bit checks (mode 2 = must-not-have, mode 3 =
 * must-have, tested via FUN_8c02b030) also pass. Picks one at random into
 * var_selectedUnlockEntry_8c228478 and sets var_cutsceneActive_8c1bb900 = 1;
...
return new class extends TestCase {
    ...
    public function test_selects_candidate_with_matching_segment_and_no_conditions(): void
    {
        ...
        $this->shouldWriteLongTo('_var_selectedUnlockEntry_8c228478', 3);
    }
    ...
    public function test_skips_candidate_when_forbidden_bit_is_set(): void
    {
        ...
        $this->shouldCall('_FUN_8c02b030')->with(4)->andReturn(1);
        $this->shouldWriteLongTo('_var_cutsceneActive_8c1bb900', 0);
    }
