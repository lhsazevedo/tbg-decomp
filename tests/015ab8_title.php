...
return new class extends TestCase {
    ...
    public function testState0x00_Init_SkipTitleAnimationWhenStartIsPressed() {
        ...
        $this->initUint32($this->addressOf('_var_peripherals_8c1ba35c') + 0x10, 8);
        $this->initUint32($this->addressOf('_var_midiHandles_8c0fcd28'), 0xbebacafe);

        /* Assert */
        $this->shouldCall('_sdMidiPlay')->with(0xbebacafe, 1, 0, 0);

        $this->shouldWrite($this->addressOf('_var_peripherals_8c1ba35c') + 16, 0);
        $this->shouldWriteSymbolOffset('_var_menuState_8c1bc7a8', 0x18, 0x0e);
        $this->shouldWrite($this->addressOf('_var_isFading_8c226568'), 0);
    ...
    public function testState0x02_Fortyfive_WaitsForTimerBeforePushingFadeOut() {
        ...
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x68, 29);
    ...
    public function testState0x02_Fortyfive_PushesFadeOutAfterThirteenTicks() {
        ...
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x18, 2);
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x68, 30);

        // Check timer
        $this->shouldWriteSymbolOffset('_var_menuState_8c1bc7a8', 0x68, 31);
    ...
    public function testState0x08_VmuWarning_AdvancesWhenAIsPressed() {
        ...
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x18, 8);
        $this->initUint32($this->addressOf('_var_peripherals_8c1ba35c') + 16, 1 << 2);
        $this->initUint32($this->addressOf('_var_midiHandles_8c0fcd28'), 0xbebacafe);
    ...
    public function testState0x09_VmuWarningFadeOut_AdvancesToTitleAfterFadeOut() {
        ...
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x18, 0x09);
        $this->initUint32($this->addressOf('_var_isFading_8c226568'), 0);
    ...
    public function testState0x0a_TitleFadeIn_AdvancesAfterFadeIn() {
        ...
        // Advance title state
        $this->shouldWriteSymbolOffset('_var_menuState_8c1bc7a8', 0x18, 0x0b);
    ...
    public function testState0x0b_BusSlide_AnimatesBusSlide() {
        ...
        $this->initUint32($this->addressOf('_var_peripherals_8c1ba35c') + 16, 0);
        // 640.0 is stored as 0x44200000
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x20, 0x44200000);
    ...
    public function testState0x0b_BusSlide_AdvancesWhenBusReachesCenterOfScreen() {
        ...
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x20, 0x43390000);

        // 185.0 - 5.111111 is stored as 0x4333e38e
        $this->shouldWrite($this->addressOf('_var_menuState_8c1bc7a8') + 0x20, 0x4333e38e);

        // Advance title state
        $this->shouldWriteSymbolOffset('_var_menuState_8c1bc7a8', 0x18, 0x0c);
    ...
    public function testState0x0c_FlagReveal_AnimatesFlag() {
        ...
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x18, 0x0c);
        // Anim skip check
        $this->initUint32($this->addressOf('_var_peripherals_8c1ba35c') + 16, 0);
        // 167.0 is stored as 0x43270000
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x24, 0x43270000);
    ...
    public function testState0x0c_FlagReveal_AdvancesWhenFlagIsRevealed() {
        ...
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x24, 0x42c40000);

        // 95.6666641235
        $this->shouldWrite($this->addressOf('_var_menuState_8c1bc7a8') + 0x24, 0x42bf5555);
    ...
    public function testState0x0e_PressStart_WaitsWhenNoInputAndTimeIsNotUp() {
        ...
        $this->initUint32($this->addressOf('_var_peripherals_8c1ba35c') + 16, 0);
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x64, 1049);
    ...
    public function testState0x0e_PressStart_AdvancesToTimeOutWhenTimeIsUp() {
        ...
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x18, 0x0e);
        $this->initUint32($this->addressOf('_var_peripherals_8c1ba35c') + 16, 0xFFFFFFF3);
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x64, 1051);

        $this->shouldWrite($this->addressOf('_var_menuState_8c1bc7a8') + 0x64, 1052);
    ...
    public function testState0x0f_StartPressed_WaitsForTimer() {
        ...
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x18, 0x0f);
    ...
    public function testState0x0f_StartPressed_AdvancesAfterTimer() {
        ...
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x18, 0x0f);
        $this->initUint32($this->addressOf('_var_menuState_8c1bc7a8') + 0x68, 10);

        $this->shouldWriteSymbolOffset('_var_menuState_8c1bc7a8', 0x68, 11);
