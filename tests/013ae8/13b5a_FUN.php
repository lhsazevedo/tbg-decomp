...
return new class extends TestCase {
    public function test_releases_when_loaded()
    {
        ...
        $this->initUint32($this->addressOf('_var_8c1bc438'), $texlist);

        // Distinct pointer values so we can assert exact free args.
        $this->initUint32($this->addressOf('_var_8c1bc43c'), 0x8c200010);
        $this->initUint32($this->addressOf('_var_8c1bc430'), 0x8c200020);
        $this->initUint32($this->addressOf('_var_8c1bc434'), 0x8c200030);
        $this->initUint32($this->addressOf('_var_8c1bc418'), 0x8c200040);
        $this->initUint32($this->addressOf('_var_8c1bc424'), 0x8c200050);

        $this->call('_FUN_8c013b5a');
        ...
        $this->shouldWriteLongTo('_var_8c1bc438', 0xffffffff);
    }
    ...
    public function test_skips_when_unloaded()
    {
        ...
        $this->initUint32($this->addressOf('_var_8c1bc438'), 0xffffffff);
