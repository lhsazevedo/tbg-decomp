...
return new class extends TestCase {
    public function test_handles_already_selected()
    {
        ...
        // target
        $this->initUint32($this->addressOf('_init_8c04442c') + 0x1c * 7 + 0x08, fdec(42.0));
        $this->initUint32($this->addressOf('_init_8c04442c') + 0x1c * 7 + 0x0c, fdec(69.0));
    ...
    public function resolveSymbols()
    {
        ...
        $this->setSize('_init_8c04442c', 0x1c * 15);
